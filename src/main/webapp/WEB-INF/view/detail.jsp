		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-sm-6" align="right">
					...
					<a type="button" class="btn btn-default" href='<c:url value="/?page=${search.page }&biginDate=${search.beginDate}&endDate=${search.endDate}&title=${search.title}&content=${search.content}"/>'>目録</a>
				</div>
			</div>
			<hr>
		    <div class="container">
